...
public:
	...
	__declspec(property(get = Getstc, put = Setstc)) short stc;
	...
	static string GetSystemDateTimeString() {
		...
		short Hour, Min, stc, Day, Month, Year;
		...
		return(to_string(Year) + "/" + to_string(Month) + "/" + to_string(Year)
			+ " - " +
			to_string(Hour) + ":" + to_string(Min) + ":" + to_string(stc));
	}
	...
	{
		return  to_string(Date.Year) + "/" + to_string(Date.Month) + "/" + to_string(Date.Year);
	}
	static string TimeToString(clsDate Date)
	{
		return  to_string(Date.Hour) + ":" + to_string(Date.Min) + ":" + to_string(Date.stc);
	}
	string DateToString()
	{
